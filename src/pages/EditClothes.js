...
import { CATEGORIES, CATEGORY_LABELS, COLORS } from '../utils/constants';
...
const EditClothes = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await clothesAPI.updateClothes(id, {
        ...formData,
        userId: user.id
      });
      navigate('/wardrobe');
    } catch (err) {
      setError('Failed to update clothes. Please try again.');
      console.error('Error:', err);
    } finally {
      setLoading(false);
    }
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="container mx-auto px-6 py-8">
        <div className="max-w-2xl mx-auto">
          <div className="mb-8">
            <h1 className="text-4xl font-bold text-gray-800 mb-2">✏️ Edit Clothes</h1>
